...
async function pushProfileNow(): Promise<void> {
  ...
  const profile = {
    ...
    applicationPacks: s.applicationPacks,
...
export async function pullProfile(): Promise<void> {
  ...
  setState({
    ...
    applicationStatus: { ...((p.applicationStatus as typeof cur.applicationStatus) || {}), ...cur.applicationStatus },
    applicationPacks: { ...((p.applicationPacks as typeof cur.applicationPacks) || {}), ...cur.applicationPacks },
